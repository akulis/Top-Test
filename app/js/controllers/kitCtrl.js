four51.app.controller('KitCtrl', [
  ...
  'Order',
  'User',
  function($scope, $location, $routeParams, Kit, ProductDisplayService, Order, User) {
    ...
    function setCurrent(item) {
      if (!item.LineItem.IsConfigurable) 
        return;
