four51.app.controller('ProductCtrl', [
  ...
  function($scope, $routeParams, $route, $location, $451, Product, ProductDisplayService, Order, Variant, User) {
    ...
    $scope.deleteVariant = function(v, redirect) {
      ...
      Variant.delete(d, function() {
        redirect
          ? $location.path('/product/' + $scope.LineItem.Product.InteropID)
          : $route.reload();
      }, function(ex) {
    ...
    $scope.addToOrder = function() {
      ...
      Order.clearshipping($scope.currentOrder).save($scope.currentOrder, function(o) {
